...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dev.Acadmy.AccountTypes.AccountType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAccountTypesApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Chapters.Chapter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppChaptersApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Emails.Email", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEmailsProgres", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Advertisementes.Entities.Advertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAdvertisementsProgres", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Chats.Entites.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppChatMessagesApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Courses.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsQuiz", "IsPdf");

                    b.ToTable("AppCoursesProgres", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Courses.Entities.CourseFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCourseFeedbacksApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Courses.Entities.CourseStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCourseStudentesApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Posts.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppComments", "Progres");
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Posts.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPosts", "Progres");
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Posts.Entities.Reaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReactions", "Progres");
                });

            modelBuilder.Entity("Dev.Acadmy.Entities.Reports.Entities.UserReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppUserReports", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Exams.ExamQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppExamQuestionsApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Lectures.Lecture", b =>
                {
                    ...
                    b.Property<int>("QuizTryCount")
                        .HasColumnType("integer");

                    b.Property<int>("SuccessQuizRate")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppLecturesApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Lectures.LectureStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLectureStudentsApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Lectures.LectureTry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLectureTrysApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.MediaItems.MediaItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMediaItemsApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Questions.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppQuestionesApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Questions.QuestionAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppQuestionAnsweresApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Questions.QuestionType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppQuestionTypesApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Quizzes.Quiz", b =>
                {
                    ...
                    b.ToTable("AppQuizesApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Supports.Support", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSupportsApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Universites.College", b =>
                {
                    ...
                    b.ToTable("AppCollegesApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Universites.GradeLevel", b =>
                {
                    ...
                    b.ToTable("AppGradeLevelsApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Universites.Subject", b =>
                {
                    ...
                    b.ToTable("AppSubjectsApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Universites.Term", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTermsApp", (string)null);
                });

            modelBuilder.Entity("Dev.Acadmy.Universites.University", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppUniversitesApp", (string)null);
                });
            ...
            modelBuilder.Entity("Dev.Acadmy.Entities.Courses.Entities.Course", b =>
                {
                    ...
                    b.HasOne("Dev.Acadmy.Universites.Subject", "Subject")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Dev.Acadmy.Entities.Posts.Entities.Comment", b =>
                {
                    b.HasOne("Dev.Acadmy.Entities.Posts.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Dev.Acadmy.Lectures.Lecture", b =>
                {
                    b.HasOne("Dev.Acadmy.Chapters.Chapter", "Chapter")
                        .WithMany("Lectures")
            ...
            modelBuilder.Entity("Dev.Acadmy.Lectures.LectureStudent", b =>
                {
                    b.HasOne("Dev.Acadmy.Lectures.Lecture", "Lecture")
                        .WithMany()
            ...
            modelBuilder.Entity("Dev.Acadmy.Questions.Question", b =>
                {
                    ...
                    b.HasOne("Dev.Acadmy.Quizzes.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Dev.Acadmy.Universites.College", b =>
                {
                    b.HasOne("Dev.Acadmy.Universites.University", "University")
                        .WithMany("Colleges")
